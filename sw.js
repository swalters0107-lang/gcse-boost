const CACHE="gcse-boost-v011a29-github";
const ASSETS=["./","./index.html","./style.css?v=011a28","./app.js?v=011a28","./fix-v011a29.js?v=011a29","./manifest.json","./icon-192.png","./icon-512.png"];
