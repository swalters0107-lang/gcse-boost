/* LevelUp10 V0.24.0 — Baseline Handoff Fix
...
(() => {
  ...
  async function renderSocialHub(){
    ...
    host.innerHTML=`<div id="socialHubMessage" class="social-message"></div>
      ...
      <section class="social-card social-battles-locked"><small>NEXT PHASE</small><h2>⚔️ Head-to-Head Battles</h2><p>Battles stay locked until Friends and safeguarding controls have been tested.</p></section>
